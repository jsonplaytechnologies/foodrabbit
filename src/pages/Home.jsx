...
import { FiClock, FiStar, FiTruck, FiShield, FiAward, FiUsers, FiArrowRight, FiCheckCircle } from 'react-icons/fi';
...
const Home = () => {
  ...
  const foodCategories = [
    { name: "Pizza", image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=200&h=150&fit=crop", count: "120+ restaurants" },
    { name: "Burgers", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=200&h=150&fit=crop", count: "85+ restaurants" },
    { name: "Sushi", image: "https://images.unsplash.com/photo-1553621042-f6e147245754?w=200&h=150&fit=crop", count: "45+ restaurants" },
    { name: "Chinese", image: "https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=200&h=150&fit=crop", count: "90+ restaurants" },
    { name: "Mexican", image: "https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200&h=150&fit=crop", count: "65+ restaurants" },
    { name: "Indian", image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=200&h=150&fit=crop", count: "55+ restaurants" }
  ];

  const groceryCategories = [
    { name: "Fresh Produce", image: "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=200&h=150&fit=crop", count: "500+ items" },
    { name: "Dairy & Eggs", image: "https://images.unsplash.com/photo-1563636619-e9143da7973b?w=200&h=150&fit=crop", count: "200+ items" },
    { name: "Meat & Seafood", image: "https://images.unsplash.com/photo-1588348835776-a6ab7baa1bdb?w=200&h=150&fit=crop", count: "150+ items" },
    { name: "Bakery", image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&h=150&fit=crop", count: "100+ items" },
    { name: "Pantry Staples", image: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=200&h=150&fit=crop", count: "800+ items" },
    { name: "Frozen Foods", image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=200&h=150&fit=crop", count: "300+ items" }
  ];
  ...
  const features = [
    {
      icon: FiTruck,
      title: "Fast Delivery",
      description: serviceType === 'grocery'
  ...
  const testimonials = [
    {
      ...
      content: "Amazing service! Everything arrives fresh and on time. The app is so easy to use.",
      rating: 5
    },
    {
      name: "Mike Chen",
      role: "Busy Parent",
      content: "Saves me so much time. Great selection and the delivery is super reliable.",
      rating: 5
    },
    {
      name: "Emily Rodriguez",
      role: "Food Enthusiast",
      content: "Love the variety of restaurants and stores available. Quality is always top-notch.",
      rating: 5
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <button className="inline-flex items-center gap-2 px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold text-lg hover:border-gray-400 transition-all">
                  Learn More
                </button>
              </div>
              ...
              <div className="flex items-center gap-8 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  <FiCheckCircle className={`w-5 h-5 ${serviceType === 'grocery' ? 'text-green-500' : 'text-orange-500'}`} />
            ...
            <div className="relative">
              ...
              } rounded-2xl transform translate-x-4 translate-y-4 -z-10`}></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 font-display">
              {serviceType === 'grocery' ? 'Shop by Category' : 'Browse Cuisines'}
            </h2>
            <p className="text-xl text-gray-600">
              {serviceType === 'grocery' ? 'Find everything you need in one place' : 'Discover your next favorite meal'}
            </p>
          </div>
