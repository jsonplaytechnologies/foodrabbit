...
import { FiShoppingCart, FiUser, FiMapPin, FiTruck, FiPackage, FiSearch } from 'react-icons/fi';
      ...
      <div className="container py-3">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-4 group">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 font-display group-hover:text-orange-600 transition-colors">Rabbit</h1>
              <p className="text-sm text-gray-500 -mt-1 font-medium">Food & Grocery Delivery</p>
            </div>
          </Link>
          ...
          <div className="flex items-center bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-1.5 shadow-inner border border-gray-200">
            ...
            >
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                ...
                <span className={`text-sm font-bold ${serviceType === 'food' ? 'text-white' : 'text-orange-600'}`}>F</span>
              </div>
            ...
            >
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                ...
                <span className={`text-sm font-bold ${serviceType === 'grocery' ? 'text-white' : 'text-green-600'}`}>G</span>
              </div>
            ...
            <div className="flex items-center bg-gray-50 rounded-xl p-1 border border-gray-200">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all ${
                  orderType === 'delivery'
                    ? `${serviceType === 'grocery' ? 'bg-green-500 shadow-md' : 'bg-orange-500 shadow-md'} text-white`
            ...
            >
              ...
              {getItemCount() > 0 && (
                <span className={`absolute -top-1 -right-1 ${
                  serviceType === 'grocery' ? 'bg-gradient-to-r from-green-500 to-emerald-500' : 'bg-gradient-to-r from-orange-500 to-red-500'
